...
@Slf4j
@Component
public class UnpaclTextResultUploadHandler implements InputMessageHandler {
    private final UserDataCache userDataCache;
    private final ReplyMessageService messageService;
    private final LocaleMessageService localeMessageService;

    public UnpaclTextResultUploadHandler(UserDataCache userDataCache, ReplyMessageService messageService, LocaleMessageService localeMessageService){
    ...
    public String handleTip() {
        return localeMessageService.getMessage("tip.HideTextResultUploadState");
    }
