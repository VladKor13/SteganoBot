...
@Slf4j
@Component
public class HideTextResultUploadHandler extends StateHandler implements InputMessageHandler {
    ...
    private SendMessage generateTip(Message inputMessage, ReplyKeyboardMarkup replyKeyboardMarkup) {
        ...
        SendMessage replyTip = new SendMessage(chatID, localeMessageService.getMessage("tip.hide-text-result-upload-state"));
